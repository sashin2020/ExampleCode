...
(function($PS) {
  "use strict";
  $PS["Example.AppState"] = $PS["Example.AppState"] || {};
  var exports = $PS["Example.AppState"];
  ...
  var MyAppState = function (x) {
      return x;
  };
  var testDictionary = (function () {
      var is = function (word) {
      ...
      return [ is("HTTP")("Hyper-Text Transfer Protocol"), is("XML")("Extended Markup Language"), is("XHR")("XML HTTP Request"), is("CSS")("Cascading Style Sheets"), is("HTML")("Hyper-Text Markup Language"), is("JSON")("JavaScript Object Notation"), is("AJAX")("Asynchronous JavaScript and XML"), is("REST")("REpresentational State Transfer"), is("ACID")("Atomicity, Consistency, Isolation, Durability"), is("CRUD")("Create, Read, Update, Delete"), is("REPL")("Read, Eval, Print, Loop"), is("UTF")("Universal Text Format"), is("ASCII")("American Standard Code for Information Interchange") ];
  })();
  var newtypeMyAppState = new Data_Newtype.Newtype(function (n) {
      return n;
  }, MyAppState);
  ...
  // purposes.
  var myAppInitState = {
      myDictionary: testDictionary,
      mySearchString: "",
      myDefinitionString: ""
  };
  exports["myAppInitState"] = myAppInitState;
  exports["newtypeMyAppState"] = newtypeMyAppState;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  "use strict";
  $PS["Example.StateTransFn"] = $PS["Example.StateTransFn"] || {};
  var exports = $PS["Example.StateTransFn"];
  var Data_Array = $PS["Data.Array"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Newtype = $PS["Data.Newtype"];
  var Example_AppState = $PS["Example.AppState"];                
  ...
  var stateTransFn = function (dictNewtype) {
      return function (f) {
          var $31 = Data_Newtype.wrap(dictNewtype);
  ...
  // Array.
  var myAppWordToggleSelect = function (i) {
      return stateTransFn(Example_AppState.newtypeMyAppState)(function ($$this) {
          var $14 = {};
          for (var $15 in $$this) {
              if ({}.hasOwnProperty.call($$this, $15)) {
                  $14[$15] = $$this[$15];
              };
          };
          $14.myDictionary = Data_Maybe.fromMaybe($$this.myDictionary)(Data_Array.modifyAt(i)(function (entry) {
              var $11 = {};
              for (var $12 in entry) {
                  if ({}.hasOwnProperty.call(entry, $12)) {
                      $11[$12] = entry[$12];
                  };
              };
              $11.isSelected = !entry.isSelected;
              return $11;
          })($$this.myDictionary));
          return $14;
      });
  ...
  var myAppSetSearchString = function (mquery) {
      return stateTransFn(Example_AppState.newtypeMyAppState)(function ($$this) {
          var $17 = {};
          for (var $18 in $$this) {
          ...
          $17.mySearchString = Data_Maybe.fromMaybe("")(mquery);
          return $17;
      });
  };
  ...
  var myAppSetDefinitionString = function (mquery) {
      return stateTransFn(Example_AppState.newtypeMyAppState)(function ($$this) {
          var $20 = {};
          for (var $21 in $$this) {
          ...
          $20.myDefinitionString = Data_Maybe.fromMaybe("")(mquery);
          return $20;
      });
  };

  // | Delete selected elements
  var myAppDeleteSelected = stateTransFn(Example_AppState.newtypeMyAppState)(function ($$this) {
      var $23 = {};
      for (var $24 in $$this) {
          if ({}.hasOwnProperty.call($$this, $24)) {
              $23[$24] = $$this[$24];
          };
      };
      $23.myDictionary = Data_Array.filter(function (entry) {
 ...
 */  
  ...
  var myAppAddWord = stateTransFn(Example_AppState.newtypeMyAppState)(function ($$this) {
      var $26 = {};
      for (var $27 in $$this) {
          if ({}.hasOwnProperty.call($$this, $27)) {
              $26[$27] = $$this[$27];
          };
      };
      $26.myDictionary = Data_Array.cons({
  ...
  exports["myAppAddWord"] = myAppAddWord;
  exports["myAppWordToggleSelect"] = myAppWordToggleSelect;
  exports["myAppDeleteSelected"] = myAppDeleteSelected;
  exports["myAppSetSearchString"] = myAppSetSearchString;
  exports["myAppSetDefinitionString"] = myAppSetDefinitionString;
...
(function($PS) {
  "use strict";
  $PS["Example.Stateless.MyDictEntryProps"] = $PS["Example.Stateless.MyDictEntryProps"] || {};
  var exports = $PS["Example.Stateless.MyDictEntryProps"];
  var Control_Category = $PS["Control.Category"];
  var Data_Array = $PS["Data.Array"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Newtype = $PS["Data.Newtype"];
  ...
  var Example_StateTransFn = $PS["Example.StateTransFn"];
  var React_Basic = $PS["React.Basic"];
  ...
  // made visible to the React.js library. The string passed to 'createComponent' will be the name of
  // the JavaScript class that is created, so it must be a valid JavaScript class name.
  var myDictionaryViewClass = React_Basic.createComponent("MyDictionaryView");
  var myDictEntryViewClass = React_Basic.createComponent("MyDictEntryView");
  var myDictEntryView = React_Basic.makeStateless(myDictEntryViewClass)(function (cprops) {
      return React_Basic_DOM_Generated.li()({
          className: (function () {
              if (cprops.props.entry.isSelected) {
          ...
          children: [ React_Basic_DOM_Generated.span()({
              ...
              children: [ React_Basic_DOM.text(cprops.props.entry.word) ]
          }), React_Basic_DOM_Generated.span()({
              className: "entry-separator",
              children: [ React_Basic_DOM.text(":") ]
          }), React_Basic_DOM_Generated.span()({
              className: "entry-definition",
              children: [ React_Basic_DOM.text(cprops.props.entry.definition) ]
          }) ],
          onClick: React_Basic_DOM_Events.capture_(function __do() {
              Example_LoggingFn.logTrue("Toggle selection on word " + Data_Show.show(Data_Show.showString)(cprops.props.entry.word))();
              return cprops.setState(Example_StateTransFn.myAppWordToggleSelect(cprops.props.i))();
          })
      });
  });
  ...
  // also a component.
  var myDictionaryView = React_Basic.makeStateless(myDictionaryViewClass)(function (cprops) {
      return React_Basic_DOM_Generated.ul()({
          className: "dictionary-view",
          children: (function () {
              var $6 = Data_Functor.map(Data_Functor.functorArray)(function (jsxWord) {
                  return jsxWord.jsx;
              });
              var $7 = (function () {
                  var $5 = Data_String_Common["null"](cprops.state.mySearchString);
                  if ($5) {
                      return Control_Category.identity(Control_Category.categoryFn);
                  };
                  return Data_Array.filter(function (jsxWord) {
                      return Data_String_CodeUnits.contains(cprops.state.mySearchString)(jsxWord.word);
                  });
              })();
              return function ($8) {
                  return $6($7($8));
  ...
  var componentPropsFor = function (self) {
      return {
          ...
          state: self.state,
          setState: (function () {
              var $9 = Data_Newtype.unwrap(Example_StateTransFn.newtypeStateTransFn);
              return function ($10) {
                  return self.setState($9($10));
              };
          })()
      };
  };
  exports["componentPropsFor"] = componentPropsFor;
  exports["myDictionaryView"] = myDictionaryView;
})(PS);
(function($PS) {
  "use strict";
  $PS["Example.MyAppProps"] = $PS["Example.MyAppProps"] || {};
  var exports = $PS["Example.MyAppProps"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Newtype = $PS["Data.Newtype"];
  var Data_Show = $PS["Data.Show"];
  var Example_AppState = $PS["Example.AppState"];
  ...
  var Example_LoggingFn = $PS["Example.LoggingFn"];
  var Example_StateTransFn = $PS["Example.StateTransFn"];
  var Example_Stateless_MyDictEntryProps = $PS["Example.Stateless.MyDictEntryProps"];
  var React_Basic = $PS["React.Basic"];
  var React_Basic_DOM = $PS["React.Basic.DOM"];
  var React_Basic_DOM_Events = $PS["React.Basic.DOM.Events"];
  var React_Basic_DOM_Generated = $PS["React.Basic.DOM.Generated"];                
          ...
          return function (stransf) {
              return React_Basic_DOM_Events.capture(React_Basic_DOM_Events.targetValue)(function (inputString) {
                  return function __do() {
                      self.setState(Data_Newtype.unwrap(Example_StateTransFn.newtypeStateTransFn)(stransf(inputString)))();
  ...
  var submitEventHandler = function (self) {
      return React_Basic_DOM_Events.capture_(function __do() {
          self.setState(Data_Newtype.unwrap(Example_StateTransFn.newtypeStateTransFn)(Example_StateTransFn.myAppAddWord))();
          return Example_LoggingFn.logTrue("Add word " + (Data_Show.show(Data_Show.showString)(self.state.mySearchString) + (" = " + Data_Show.show(Data_Show.showString)(self.state.myDefinitionString))))();
      });
  };
  ...
  var newMyApp = React_Basic.toReactComponent()(Example_Library.myAppPropsFromJS)(Example_Library.theMyAppClass)({
      initialState: Example_AppState.myAppInitState,
      render: function (self) {
          var cprops = Example_Stateless_MyDictEntryProps.componentPropsFor(self);
          return React_Basic_DOM_Generated.div_([ React_Basic_DOM_Generated.div_([ React_Basic_DOM_Generated.span_([ React_Basic_DOM.text("Word:") ]), React_Basic_DOM_Generated.input()({
              onChange: textEntryEventHandler(self)("search")(Example_StateTransFn.myAppSetSearchString),
              onSubmit: submitEventHandler(self)
          }) ]), React_Basic_DOM_Generated.div_([ React_Basic_DOM_Generated.span_([ React_Basic_DOM.text("Definition:") ]), React_Basic_DOM_Generated.input()({
              onChange: textEntryEventHandler(self)("definition")(Example_StateTransFn.myAppSetDefinitionString)
              ...
              onClick: React_Basic_DOM_Events.capture_(function __do() {
                  self.setState(Data_Newtype.unwrap(Example_StateTransFn.newtypeStateTransFn)(Example_StateTransFn.myAppDeleteSelected))();
                  return Example_LoggingFn.logTrue("Deleted selected items")();
              })
          }) ]), Example_Stateless_MyDictEntryProps.myDictionaryView(cprops) ]);
      }
  });
  exports["newMyApp"] = newMyApp;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var Example_Library = $PS["Example.Library"];
  var Example_LoggingFn = $PS["Example.LoggingFn"];
  var Example_MyAppProps = $PS["Example.MyAppProps"];
  var React_Basic = $PS["React.Basic"];
  var React_Basic_DOM = $PS["React.Basic.DOM"];
  ...
  var main = function __do() {
      ...
      if (maybeContainer instanceof Data_Maybe.Just) {
          return React_Basic_DOM.render(React_Basic.element(Example_MyAppProps.newMyApp)(Example_Library.myAppInitProps))(maybeContainer.value0)();
      };
      throw new Error("Failed pattern match at Main (line 25, column 3 - line 27, column 77): " + [ maybeContainer.constructor.name ]);
  };
  exports["main"] = main;
})(PS);
PS["Main"].main();